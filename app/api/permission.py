...
# permission_model = api.model('post a permission', {"name": fields.String(description="name of permission", required=True), "code": fields.String(
#     description="code of permission", required=True), "active": fields.Boolean(description="status of permission", required=True)})
